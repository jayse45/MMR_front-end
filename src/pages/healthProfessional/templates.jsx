...
const TEMPLATES_URL = UrlHelper.createApiUrlPath("/api/templates/");
...
const ExerciseTemplatePage = () => {
  ...
  useEffect(() => {
    ...
    /* page=${
        page - 1
      }&limit=${limit}&query=${query}&bodyPart=${bodyPart} */
    FetchManager.fetch({
      url: `${TEMPLATES_URL}`,
      success_cb: (res) => {
  ...
  return (
    <Layout navList={NavListItems}>
      <Box component={"main"}>
        <Box component={"section"}>
          ...
          <Container sx={{ display: "flex", flexDirection: "row" }}>
            ...
            >
              <Button sx={{ height: "1.2em" }} href="/templateform">
                Add Template
              </Button>
            </Container>
          </Container>
        ...
        >
          <Grid container rowSpacing={1} spacing={2}>
            ...
            <Grid
              ...
              alignItems={"flex-end"}
            >
              <Button sx={{ height: "1.2em" }} onClick={addTemplate}>
                Add Template
              </Button>
            </Grid>
          </Grid>
              ...
              {templates.map((template) => (
                ...
                >
                  <ViewTemplateCard
                    modify
                    template={template}
                    editAction={editTemplate(template)}
                    deleteAction={deleteTemplate(template)}
                  />
                </Grid>
              ))}
            </Grid>
      ...
      <CustomModal onClose={handleModalClose}>
        ...
        {modalContent === "add" && (
          <AddExerciseTemplatesForm success_cb={handleModalClose} />
        )}
      </CustomModal>
    </Layout>
  );
